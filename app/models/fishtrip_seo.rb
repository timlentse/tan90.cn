class FishtripSeo
  ...
  def get_breadcrumb
    ...
    when 'query'
      [{:text=>'首页', :url=>'/'}, {:text=>"#{@country}民宿", :url=>"/#{@hotel.country}/"},{:text=>"#{@country}#{@city_name}民宿搜索页"}]
    when 'city'
      [{:text=>'首页', :url=>'/'}, {:text=>"#{@country}民宿", :url=>"/#{@hotel.country}/"},{:text=>"#{@country}#{@city_name}民宿"}]
    when 'detail'
      [{:text=>'首页', :url=>'/'}, {:text=>"#{@country}民宿", :url=>"/#{@hotel.country}/"},{:text=>"#{@country}#{@city_name}民宿", :url=>"/#{@hotel.country}/#{@hotel.city_en}/"}, {:text=>@hotel.name}]
    end
  end
  ...
  def tdk
    ...
    when 'detail'
      {
        :title=>"#{@hotel.name}_#{@city_name}民宿价格-#{@city_name}民宿",
